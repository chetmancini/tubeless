...
| Logo and social card | `../docs/assets/logo.svg` and `../docs/assets/social.svg`; `bun scripts/rasterize-og.mjs` writes `public/og.jpg` at 1200×630 JPEG. `public/og.png` is a historical URL only |
