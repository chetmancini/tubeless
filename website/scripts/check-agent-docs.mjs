...
const socialImage = `https://tubeless.io/og.jpg?v=${packageVersion}`;
...
assert.ok(homepage.includes(`property="og:image" content="${socialImage}"`));
...
assert.ok(homepage.includes(`name="twitter:image" content="${socialImage}"`));
