...
`definePipelineCommand(pipeline)` from `tubeless/cli` infers flags from its input schema.
See the [CLI guide](./docs/cli.md) for the one-line wrapper and optional catalogs. From this repository:
