...
| Other constants    | `PIPELINE_FINALIZE_STEP_ID` (`__finalize__`), `RUN_MODEL_VERSION` (`2`), `PIPELINE_STUDIO_CONFIG_VERSION` (`1`)                                                                                                                                                                                                                                   | Reserved finalize id and stored-run/studio versions.                                                                                                           |
