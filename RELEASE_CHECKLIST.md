...
| Export paths       | `tubeless`, `tubeless/cli`, `tubeless/batch`, `tubeless/node`, `tubeless/rate-limit`, `tubeless/retry`, `tubeless/testing`, `tubeless/tracing`, `tubeless/workbench` | CLI owns command and project declarations; workbench retains registration aliases. Studio and storage remain internal. |
